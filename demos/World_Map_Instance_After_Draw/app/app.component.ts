...
@Component({
    moduleId: module.id,
    selector: 'my-app',
    template: `<div anymap style="width: 100%; height: 521px;" [acInstance]="myMap" [acChartDraw]="bubblesSize" [acData]="mySeriesData" acGeoData="anychart.maps.world" acTitle="Worlds Population by Country"></div>`,
})
export class AppComponent {
    ...
    constructor(private acService: AnychartService) {
        ...
        var density_data = this.mySeriesData.mapAs({'size': ['population']});
        ...
        series_choropleth.tooltip().useHtml(true);
    ...
    myMap: any = anychart.map();

    bubbleSize = function(chart: any) {
